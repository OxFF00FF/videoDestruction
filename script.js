...
ImageData.data[dpos+3] = sImageData.data[spos+3]; //A
}
...
var PAINTRECT = {x:0, y:0, width:1300, height:600};
...
function processFrame(){
	...
	for(var i=0; i<tiles.length; i++){
		...
		if(tile.force > 0.0001){
			...
			//contract
			var diffx = (tile.originX-tile.currentX)*0.3;
			var diffy = (tile.originY-tile.currentY)*0.3;
			var diffRot = (0-tile.rotation)*0.3;
